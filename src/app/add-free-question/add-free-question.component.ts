...
@Component({
  selector: 'app-add-free-question',
  templateUrl: './add-free-question.component.html',
  styleUrls: ['./add-free-question.component.css']
})
export class AddFreeQuestionComponent implements OnInit {
